...
(function() {
	...
	(function(Genre, obj) {
		...
		},
		{
			...
			country2: [0, 0, "カントリーロード2", "Country Road 2", "country"],
			...
			gradientwalls: [0, 0, "グラデーション・ウォールズ", "Gradient Walls"],
			...
			heyawake2: [0, 0, "へやわけ2", "Heyawake 2", "heyawake"],
			...
			mines2: [0, 0, "マインスイーパ2", "Minesweeper 2", "kurotto"],
			...
			nurikabe2: [0, 0, "ぬりかべ2", "Nurikabe 2", "nurikabe"],
			...
			sudoku2: [0, 0, "数独2", "Sudoku 2", "sudoku"],
			...
			yajilin2: [0, 0, "ヤジリン2", "Yajilin 2", "yajilin"],
