...
(function(pidlist, classbase) {
	...
	],
	{
		...
		"Board@mochikoro,mochinyoro,cornerch": {
		...
		"AreaUnshade8Graph:AreaUnshadeGraph@mochikoro,mochinyoro,cornerch": {
		...
		"AnsCheck@cornerch#1": {
			checklist: [
				"checkUnshadeRectEven",
				"checkUnshadeRectOdd",
				"checkNumberAndUnshadeSize",
				"checkConnectUnshaded",
				"doneShadingDecided"
			]
		},
		...
		"AnsCheck@mochikoro,mochinyoro,cornerch": {
		...
		"AnsCheck@cornerch": {
			checkConnectUnshaded: function() {
				this.checkOneArea(this.board.ublk8mgr, "csDivide8");
			},
			checkUnshadeRectEven: function() {
				this.checkAllArea(
					this.board.ublkmgr,
					function(w, h, a, n) {
						if (n > 0 && n !== a) {
