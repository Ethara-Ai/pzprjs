...
_PUZZLES = {
    "easy": {
        "rows": 5, "cols": 5,
        "url_body": "06g802i2k2i206g80",
        "num_clues": 12,
        "num_arrows": 4,
        "moves_required": [
            "mouse,left,4,0,4,2", "mouse,left,6,0,6,2",
            "mouse,left,2,2,2,4", "mouse,left,8,2,8,4",
            "mouse,left,0,4,0,6", "mouse,left,10,4,10,6",
            "mouse,left,2,6,2,8", "mouse,left,8,6,8,8",
            "mouse,left,4,8,4,10", "mouse,left,6,8,6,10",
            "mouse,left,4,0,6,0", "mouse,left,2,2,4,2",
            "mouse,left,6,2,8,2", "mouse,left,0,4,2,4",
            "mouse,left,8,4,10,4", "mouse,left,0,6,2,6",
            "mouse,left,8,6,10,6", "mouse,left,2,8,4,8",
            "mouse,left,6,8,8,8", "mouse,left,4,10,6,10",
        ],
        "moves_hint": [
            "mouse,left,0,0,0,2", "mouse,left,2,0,2,2",
            "mouse,left,8,0,8,2", "mouse,left,10,0,10,2",
            "mouse,left,0,2,0,4", "mouse,left,4,2,4,4",
            "mouse,left,6,2,6,4", "mouse,left,10,2,10,4",
            "mouse,left,2,4,2,6", "mouse,left,4,4,4,6",
            "mouse,left,6,4,6,6", "mouse,left,8,4,8,6",
            "mouse,left,0,6,0,8", "mouse,left,4,6,4,8",
            "mouse,left,6,6,6,8", "mouse,left,10,6,10,8",
            "mouse,left,0,8,0,10", "mouse,left,2,8,2,10",
            "mouse,left,8,8,8,10", "mouse,left,10,8,10,10",
            "mouse,left,0,0,2,0", "mouse,left,2,0,4,0",
            "mouse,left,6,0,8,0", "mouse,left,8,0,10,0",
            "mouse,left,0,2,2,2", "mouse,left,4,2,6,2",
            "mouse,left,8,2,10,2", "mouse,left,2,4,4,4",
            "mouse,left,4,4,6,4", "mouse,left,6,4,8,4",
            "mouse,left,2,6,4,6", "mouse,left,4,6,6,6",
            "mouse,left,6,6,8,6", "mouse,left,0,8,2,8",
            "mouse,left,4,8,6,8", "mouse,left,8,8,10,8",
            "mouse,left,0,10,2,10", "mouse,left,2,10,4,10",
            "mouse,left,6,10,8,10", "mouse,left,8,10,10,10",
        ],
    },
    "medium": {
        "rows": 7, "cols": 7,
